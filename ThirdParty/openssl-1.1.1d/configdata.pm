...
our %config = (
  ...
  openssldir => "F:\\work\\cryptopals\\ThirdParty\\openssl-1.1.1d\\build\\debug_static",
  options => "--prefix=F:\\work\\cryptopals\\ThirdParty\\openssl-1.1.1d\\build\\debug_static --openssldir=F:\\work\\cryptopals\\ThirdParty\\openssl-1.1.1d\\build\\debug_static no-asan no-buildtest-c++ no-crypto-mdebug no-crypto-mdebug-backtrace no-devcryptoeng no-dynamic-engine no-ec_nistp_64_gcc_128 no-egd no-external-tests no-fuzz-afl no-fuzz-libfuzzer no-heartbeats no-md2 no-msan no-rc5 no-sctp no-shared no-ssl-trace no-ssl3 no-ssl3-method no-ubsan no-unit-test no-weak-ssl-ciphers no-zlib no-zlib-dynamic",
  perl_archname => "MSWin32-x64-multi-thread",
  perl_cmd => "C:\\Perl64\\bin\\perl.exe",
  perl_version => "5.24.3",
  perlargv => [ "debug-VC-WIN64A", "no-shared", "--prefix=F:\\work\\cryptopals\\ThirdParty\\openssl-1.1.1d\\build\\debug_static", "--openssldir=F:\\work\\cryptopals\\ThirdParty\\openssl-1.1.1d\\build\\debug_static" ],
  perlenv => {
      "AR" => undef,
      "ARFLAGS" => undef,
      "AS" => undef,
  ...
  prefix => "F:\\work\\cryptopals\\ThirdParty\\openssl-1.1.1d\\build\\debug_static",
  processor => "",
